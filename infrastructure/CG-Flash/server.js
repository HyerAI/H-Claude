/**
 * KS-Flash - Kaprekar Gemini Flash Gateway
 *
 * Routes Claude Code (Anthropic API format) to Google AI Gemini Flash Preview.
...
const DEFAULT_MODEL = process.env.KS_PROXY_MODEL || 'gemini-3-flash-preview';
const PORT = process.env.KS_PROXY_PORT || 2405;
...
// Start server
app.listen(PORT, () => {
    log('info', `CG-Flash started on http://localhost:${PORT}`);
